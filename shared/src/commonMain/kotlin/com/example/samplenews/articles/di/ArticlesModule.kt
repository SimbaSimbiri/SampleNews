...
val articlesModule = module {
    ...
    // instantiate it here since it will be needed in other features in the app besides
    // the article. We will thus create a new universal di folder for this in the shared module
